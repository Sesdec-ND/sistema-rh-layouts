                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900">
                                        {{ \Carbon\Carbon::parse($servidor->data_nascimento)->format('d/m/Y') }}</p>
                                </div>
                                <div>
                                ...
                                <div class="md:col-span-2 mt-6">
                                    <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">Dados Profissionais
                                    </h3>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900">
                                        @if ($servidor->lotacao)
                                            {{ $servidor->lotacao->nomeLotacao }}
                                            @if ($servidor->lotacao->sigla)
                                                ({{ $servidor->lotacao->sigla }})
                                            @endif
                                        @else
                                            Não informado
                                        @endif
                    ...
                    @if ($servidor->lotacao)
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-gray-900 font-semibold">{{ $servidor->lotacao->nomeLotacao }}</p>
                            </div>
                            <div>
                    ...
                    @if ($servidor->vinculo)
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-gray-900 font-semibold">{{ $servidor->vinculo->nomeVinculo }}</p>
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-gray-900">
                                    {{ \Carbon\Carbon::parse($servidor->vinculo->created_at)->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                    @else
                        <div class="text-center py-8 text-gray-500">
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                    ...
                                    <div class="space-y-2">
                                        <div>
                                            ...
                                            <p class="text-gray-900">
                                                {{ \Carbon\Carbon::parse($feria->data_inicio)->format('d/m/Y') }}</p>
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-600">Data Fim</label>
                                            <p class="text-gray-900">
                                                {{ \Carbon\Carbon::parse($feria->data_fim)->format('d/m/Y') }}</p>
                                        </div>
                                        <div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900">
                                                {{ \Carbon\Carbon::parse($curso->data_conclusao)->format('d/m/Y') }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach

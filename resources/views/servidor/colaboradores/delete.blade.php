...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            ...
            <p class="text-sm text-gray-600 mt-1">Itens excluídos ficam disponíveis para restauração por 30 dias</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">
                                        {{ $servidor->nome_completo ?? $servidor->name }}
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">Mat: {{ $servidor->matricula ?? 'N/A' }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                ...
                                $perfilNome = $servidor->perfil->nomePerfil ?? 'N/A';
                                $color = $badgeColors[$perfilNome] ?? 'bg-gray-100 text-gray-800';
                            @endphp
                            ...
                            <div class="flex space-x-2">
                                ...
                                <form action="{{ route('servidores.force-delete', $servidor->id) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" 
                                            ...
                                            onclick="return confirm('Tem certeza que deseja excluir permanentemente {{ $servidor->nome_completo ?? $servidor->name }}? Esta ação não pode ser desfeita.')">

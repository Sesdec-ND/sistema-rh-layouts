...
<?php $__env->startSection('title', 'Dashboard - Diretor'); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($totalColaboradores - 2); ?></p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route('diretor.colaboradores')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/servidor/diretor/dashboard.blade.php ENDPATH**/ ?>
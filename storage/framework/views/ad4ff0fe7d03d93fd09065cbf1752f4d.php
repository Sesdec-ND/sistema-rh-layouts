...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Gerenciar Colaboradores</h1>
            <p class="text-gray-600 mt-2">Gerencie todos os colaboradores do sistema</p>
            <button type="button" onclick="location.href='<?php echo e(route('servidores.create')); ?>'"
        ...
        <div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Buscar</label>
                        <input type="text" placeholder="Nome, CPF, email..."
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Perfil</label>
                    ...
                    <div class="flex items-end">
                        <button
                            class="w-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
                            <i class="fas fa-filter mr-2"></i>
                            Filtrar
                        </button>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="bg-white px-6 py-4 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Mostrando <span class="font-semibold">1</span> a <span
                                class="font-semibold"><?php echo e(count($colaboradores)); ?></span> de <span
                                class="font-semibold"><?php echo e(count($colaboradores)); ?></span> resultados
                        </div>
                        <div class="flex space-x-2">
                            <button

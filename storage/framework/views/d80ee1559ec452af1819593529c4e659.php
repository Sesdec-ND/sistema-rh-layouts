<?php $__env->startSection('title', 'Dashboard - RH'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalColaboradores); ?></p>
                    </div>
                ...
                <div class="card clickable-card" onclick="redirectToServidores()">
                    <div class="card-body">
                        <h5 class="card-title">Total Colaboradores</h5>
                        <h2 class="card-value">3</h2>
                        <p class="card-text">12% desde último mês</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($totalPerfis); ?></p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="<?php echo e(route('admin.acesso-sistema')); ?>"
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="font-semibold text-gray-800">Gerenciar Acesso</h3>
                            <p class="text-sm text-gray-600">Atribuir perfis de acesso</p>
                        </div>
                    </div>
                </a>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
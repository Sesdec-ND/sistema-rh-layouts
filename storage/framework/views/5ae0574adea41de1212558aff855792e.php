...
<head>
    ...
    <title>Admin RH - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <div class="sidebar sidebar-expanded bg-blue-800 text-white fixed h-full overflow-y-auto z-50" id="sidebar">
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>"
                class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 transition duration-200 <?php echo e(request()->routeIs('rh.dashboard') ? 'bg-blue-700' : ''); ?>">
            ...
            <!-- Relatórios -->
            <a href="<?php echo e(route('admin.relatorios.index')); ?>"
                class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 transition duration-200 <?php echo e(request()->routeIs('rh.relatorios') ? 'bg-blue-700' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.acesso-sistema')); ?>"
                class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 transition duration-200 <?php echo e(request()->routeIs('admin.acesso-sistema') ? 'bg-blue-700' : ''); ?>">
                <i class="fas fa-key w-6 text-center"></i>
                <span id="nav-acesso">Acesso ao Sistema</span>
            </a>

            <!-- Perfis de Acesso -->
            <a href="<?php echo e(route('admin.perfis-acesso')); ?>"
            ...
            <div class="pt-4">
                ...
                <a href="<?php echo e(route('admin.configuracoes-sistema')); ?>"
                    class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 transition duration-200">
                    <i class="fas fa-cog w-6 text-center"></i>
                    <span id="nav-config">Configurações do Sistema</span>
                </a>
                <a href="<?php echo e(route('admin.seguranca')); ?>"
                    class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 transition duration-200">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="<?php echo e(route('perfil-pessoal.show')); ?>"
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-500"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
...
<?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
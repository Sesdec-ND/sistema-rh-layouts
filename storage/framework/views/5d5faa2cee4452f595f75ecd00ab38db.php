...
<?php $__env->startSection('title', 'Configurações do Sistema - RH'); ?>
...
<div class="space-y-6">
    ...
    <form action="<?php echo e(route('admin.configuracoes-sistema.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="geral[itens_por_pagina]" 
                               value="<?php echo e($configuracoes['geral']['itens_por_pagina'] ?? 15); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/admin/configuracoes-sistema.blade.php ENDPATH**/ ?>
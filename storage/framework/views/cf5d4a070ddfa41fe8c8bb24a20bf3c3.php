...
<?php $__env->startSection('title', 'Relatórios - RH'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition duration-200">
            ...
            <div class="flex space-x-2">
                <a href="<?php echo e(route('admin.relatorios.colaboradores')); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition duration-200">
            ...
            <div class="flex justify-between items-center text-sm text-gray-500 mb-4">
                <span><i class="fas fa-calendar mr-1"></i><?php echo e(now()->format('m/Y')); ?></span>
                <span>PDF, Excel</span>
            </div>
            <div class="flex space-x-2">
                <a href="<?php echo e(route('admin.relatorios.folha-pagamento')); ?>" 
                ...
                <a href="<?php echo e(route('admin.relatorios.folha-pagamento')); ?>?download=1" 
                   class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg text-sm font-semibold transition duration-200">
                    <i class="fas fa-download"></i>
                </a>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition duration-200">
            ...
            <div class="flex space-x-2">
                <a href="<?php echo e(route('admin.relatorios.performance')); ?>" 
                ...
                <a href="<?php echo e(route('admin.relatorios.performance')); ?>?download=1" 
                   class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg text-sm font-semibold transition duration-200">
                    <i class="fas fa-download"></i>
                </a>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.relatorios.gerados')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-semibold">
                Ver Todos <i class="fas fa-arrow-right ml-1"></i>
            </a>
        </div>
        <div class="space-y-4">
            <?php $__currentLoopData = [1, 2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Gerado em <?php echo e(now()->subHours(2)->format('d/m/Y H:i')); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/admin/relatorios/index.blade.php ENDPATH**/ ?>
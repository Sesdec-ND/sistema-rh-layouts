...
<?php $__env->startSection('title', 'Políticas de Segurança - RH'); ?>
...
<div class="space-y-6">
    ...
    <form action="<?php echo e(route('admin.seguranca.politicas.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="tamanho_minimo_senha" 
                               value="<?php echo e($politicas['tamanho_minimo_senha'] ?? 8); ?>"
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="exigir_maiusculas" 
                                       <?php echo e(($politicas['exigir_maiusculas'] ?? true) ? 'checked' : ''); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="exigir_numeros" 
                                       <?php echo e(($politicas['exigir_numeros'] ?? true) ? 'checked' : ''); ?>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="exigir_especiais" 
                                       <?php echo e(($politicas['exigir_especiais'] ?? false) ? 'checked' : ''); ?>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="max_tentativas_login" 
                               value="<?php echo e($politicas['max_tentativas_login'] ?? 5); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                               min="1" max="10">
                    ...
                    <div>
                        ...
                        <input type="number" name="bloqueio_tempo_minutos" 
                               value="<?php echo e($politicas['bloqueio_tempo_minutos'] ?? 30); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                               min="1" max="1440">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="login_dois_fatores" 
                                   <?php echo e(($politicas['login_dois_fatores'] ?? false) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/admin/politicas-seguranca.blade.php ENDPATH**/ ?>
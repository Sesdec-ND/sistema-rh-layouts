...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="racaCor" name="racaCor" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['racaCor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Amarela" <?php echo e(old('racaCor') == 'Amarela' ? 'selected' : ''); ?>>Amarela</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="tipoSanguineo" name="tipoSanguineo" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['tipoSanguineo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="Politec" <?php echo e(old('idLotacao') == 'Politec' ? 'selected' : ''); ?>>Politec</option>
                            <option value="Bombeiros" <?php echo e(old('idLotacao') == 'Bombeiros' ? 'selected' : ''); ?>>Bombeiros</option>
                        </select>

...
<?php $__env->startSection('title', 'Perfis de Acesso - RH'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="bg-blue-100 text-blue-800 px-4 py-2 rounded-lg">
            ...
            <?php echo e($perfis->count()); ?> Perfis Configurados
        </div>
    </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($perfis->count()); ?></p>
                </div>
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($perfil->nomePerfil); ?></div>
                                    <div class="text-sm text-gray-500">ID: <?php echo e($perfil->id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($perfil->descricao); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                                    <?php echo e($totalPermissoes); ?> permissões
                                </span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="<?php echo e(route('admin.perfis-acesso.edit', $perfil->id)); ?>" 
                                   class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200 flex items-center">
                                    <i class="fas fa-edit mr-2"></i>
                                    Editar
                                </a>
                                <a href="<?php echo e(route('admin.perfis-acesso.permissoes', $perfil->id)); ?>" 
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div class="flex justify-between items-center">
                <p class="text-sm text-gray-600">
                    Mostrando <span class="font-medium"><?php echo e($perfis->count()); ?></span> perfis
                </p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SESDEC - GETEC\sistema-rh\resources\views/admin/perfis-acesso.blade.php ENDPATH**/ ?>